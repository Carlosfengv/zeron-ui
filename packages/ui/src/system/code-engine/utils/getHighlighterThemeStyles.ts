import { normalizeThemeColors } from '#system/code-engine/theming/color';
...
// styles
//
// The base foreground/background flow through the local theme normalizer's
...
// that normalizeThemeColors adds, so the emitted string stays
