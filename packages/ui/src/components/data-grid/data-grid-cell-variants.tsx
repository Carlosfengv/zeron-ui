/* biome-ignore-all lint/a11y/useSemanticElements: Editable grid cells use ARIA roles on divs to preserve spreadsheet-style focus and virtualization behavior. */
      ...
      {isEditing ? (
        ...
        >
          <SelectTrigger
            ...
            className="size-full min-w-0 items-start border-none p-0 shadow-none hover:bg-transparent focus-visible:ring-0 [&>span]:items-start [&>svg]:hidden"
          />
          <SelectContent
            data-grid-cell-editor=""
                    ...
                    {files.map((file) => {
                      ...
                      return (
                        <div
                          ...
                          className="flex items-center gap-2 rounded-lg border bg-muted px-2 py-1.5 data-pending:opacity-60"
                        >
                          {FileIcon && (
