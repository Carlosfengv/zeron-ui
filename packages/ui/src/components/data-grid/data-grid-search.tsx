/* biome-ignore-all lint/a11y/useSemanticElements: Search panel is positioned inside the grid overlay and keeps div semantics for layout. */
...
function DataGridSearchImpl({
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-1 whitespace-nowrap text-fg-muted text-label">
