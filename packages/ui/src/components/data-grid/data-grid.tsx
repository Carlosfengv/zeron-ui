/* biome-ignore-all lint/a11y/useSemanticElements: Virtualized ARIA grid uses div roles to support spreadsheet navigation, pinned columns, and measured rows. */
          ...
          >
            ...
            >
              <div
                role="gridcell"
                tabIndex={0}
                className="relative flex h-control-md grow items-center bg-transparent transition-colors duration-fast hover:bg-hover focus:bg-active focus:outline-none"
                style={{
