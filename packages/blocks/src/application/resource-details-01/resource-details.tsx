...
/** Complete resource-detail recipe based on the Zentirx gateway provider panel. */
export function ResourceDetails({ className, defaultEnabled = true }: ResourceDetailsProps) {
