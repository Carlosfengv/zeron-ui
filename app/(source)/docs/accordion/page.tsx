  ...
  return (
    ...
    >
      <DocSection title={t("standalone")}>
        <p className="text-[13px] text-muted-foreground">{t("standaloneDescription")}</p>
      ...
      <DocSection title={t("singleExpand")}>
        <p className="text-[13px] text-muted-foreground">{t("singleExpandDescription")}</p>
      ...
      <DocSection title={t("multiExpand")}>
        <p className="text-[13px] text-muted-foreground">{t("multiExpandDescription")}</p>
