...
const buttonProps: PropDef[] = [
  { name: "variant", type: '"primary" | "destructive" | "secondary" | "tertiary" | "ghost"', default: '"primary"', description: "Visual style of the button. Use destructive for irreversible or dangerous actions." },
...
type PlayVariant = "primary" | "destructive" | "secondary" | "tertiary" | "ghost";
...
function ButtonPlayground() {
  ...
  const randomize = () => {
    ...
    setVariant(pick(["primary", "destructive", "secondary", "tertiary", "ghost"] as const));
