...
export default function SurfacesDoc() {
  return (
    <DocPage
      ...
      title="Surfaces"
    >
      <DocSection title="Semantic roles">
        <p className="max-w-[62ch] text-body-sm leading-relaxed text-muted-foreground">
          Surface names describe a container&apos;s relationship to its substrate.
          They are the complete public API; components never select a numbered
          color or shadow.
        </p>
      ...
      <DocSection title="Relative nesting">
        <p className="max-w-[62ch] text-body-sm leading-relaxed text-muted-foreground">
          Providers carry the current semantic substrate through ordinary DOM
          and portals. Floating content resolves upward when it opens inside an
          overlay, while its shadow keeps the same spatial meaning.
        </p>
        <ComponentPreview
          code={NESTING_CODE}
      ...
      <DocSection title="Token contract">
          ...
          <table className="w-full min-w-[580px] border-collapse text-left text-body-sm">
            <thead>
              <tr className="border-b border-border bg-muted/40 text-caption text-muted-foreground">
                <th className="px-3 py-2 font-normal">CSS token</th>
      ...
      <DocSection title="Shadow contract">
        <p className="max-w-[62ch] text-body-sm leading-relaxed text-muted-foreground">
          Shadows express spatial separation, so Top reuses Floating rather than
          inventing a progressively stronger shadow.
        </p>
