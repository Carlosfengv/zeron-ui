...
import { DocSection } from "@/docs/DocPage";
      ...
      {queue.map((item, i) => {
        ...
        return (
          <motion.div
            ...
            className="absolute bottom-0 left-7 right-7 flex items-center gap-2 rounded-[20px] bg-accent-subtle px-3.5 text-[14px] text-muted-foreground shadow-floating"
          >
