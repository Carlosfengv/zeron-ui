...
export const docEntries = [
  ...
  entry({ slug: "avatar", section: "data-display", icon: "doc-badge", name: "Avatar", description: "Image and fallback primitives for people, agents, and accounts, with status and group composition.", isNew: true, gridSize: "small", order: 190, registryItem: { name: "avatar", type: "registry:ui" } }),
