...
export const docEntries = [
  ...
  entry({ slug: "combobox", section: "components", icon: "doc-select", name: "Combobox", description: "Filterable single- or multi-select with typed object values, groups, chips, and custom triggers.", isNew: true, gridSize: "medium", order: 950 }),
  ...
  entry({ slug: "filter-builder", section: "components", icon: "doc-data-table", name: "FilterBuilder", description: "Composable typed filters for complex data views, with text, number, option, boolean, date, async, and custom editors.", isNew: true, gridSize: "large", order: 1125 }),
  entry({ slug: "filter-query-input", section: "components", icon: "doc-input", name: "FilterQueryInput", description: "Structured cmdk query input with configurable fields, aliases, codecs, and portable filter clauses.", isNew: true, gridSize: "large", order: 1130 }),
  ...
  entry({ slug: "status-overview", section: "components", icon: "doc-card", name: "StatusOverview", description: "Inspectable timeline and node-status rail with semantic states, a shared tooltip, and keyboard navigation.", isNew: true, gridSize: "large", order: 1180 }),
  ...
  entry({ slug: "empty", section: "components", icon: "doc-info-item", name: "Empty", description: "Composable empty and first-use states for pages, sections, and inline data surfaces, with custom media and theme-aware illustrations.", isNew: true, gridSize: "medium", order: 1325 }),
  ...
  entry({ slug: "skeleton", section: "components", icon: "doc-card", name: "Skeleton", description: "Token-native loading placeholder that composes into avatar, card, text, form, and table layouts.", isNew: true, gridSize: "small", order: 2075 }),
  ...
  entry({ slug: "sortable-collection", section: "components", icon: "doc-data-table", name: "SortableCollection", description: "Controlled reorderable list with optional inline editing, removal, and catalog-based adding.", isNew: true, gridSize: "large", order: 2175 }),
  ...
  entry({ slug: "time-range-histogram", section: "components", icon: "doc-slider", name: "TimeRangeHistogram", description: "Stacked time-bucket histogram with controlled pointer and keyboard range selection.", isNew: true, gridSize: "large", order: 2550 }),
  entry({ slug: "temporal-picker", section: "components", icon: "doc-slider", name: "Temporal Picker", description: "Date, time, and date-time controls with explicit commitment, relative presets, availability rules, and IANA time-zone handling.", isNew: true, gridSize: "large", order: 2575 }),
