...
export const docEntries = [
  ...
  blockEntry({ slug: "resource-list-page-01", section: "application", icon: "doc-sidebar", name: "Resource List Page", description: "The standard Sidebar Basic application layout with its project overview replaced by a controlled resource DataTable.", registryItem: { name: "resource-list-page-01", type: "registry:block" }, isNew: true, order: 69 }),
