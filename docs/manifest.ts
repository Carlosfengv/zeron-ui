...
export const sectionDefinitions: readonly DocSectionDefinition[] = [
  ...
  { id: "navigation", collection: "components", order: 300, navigationKey: "navigation" },
...
export const docEntries = [
  ...
  entry({ slug: "auth-layout", section: "layout", icon: "doc-app-shell", name: "AuthLayout", description: "Full-height centered composition for authentication flows, with responsive widths and optional header and footer regions.", isNew: true, order: 150 }),
  ...
  entry({ slug: "sidebar", section: "navigation", icon: "doc-sidebar", name: "Sidebar", description: "Responsive navigation rail with desktop collapse and a mobile drawer.", order: 300 }),
  entry({ slug: "top-nav", section: "navigation", icon: "doc-top-nav", name: "TopNav", description: "Composable top navigation with brand, primary links, and actions.", order: 400 }),
  entry({ slug: "nav-menu", section: "navigation", icon: "doc-nav-menu", name: "NavMenu", description: "Router-agnostic navigation primitives shared by Sidebar and TopNav.", order: 500 }),
  entry({ slug: "accordion", section: "navigation", icon: "doc-accordion", name: "Accordion", description: "Collapsible sections with animated expand/collapse and proximity hover in grouped mode.", gridSize: "large" }),
  entry({ slug: "alert", section: "feedback", icon: "doc-info-item", name: "Alert", description: "Composable in-context callout with semantic statuses, optional icon, supporting detail, and action.", isNew: true, gridSize: "medium", order: 150 }),
  entry({ slug: "inline-notice", section: "feedback", icon: "doc-badge", name: "InlineNotice", description: "Quiet inline emphasis that composes with Badge, with an optional semantic emphasized variant.", isNew: true, gridSize: "medium", order: 175 }),
  entry({ slug: "avatar", section: "data-display", icon: "doc-badge", name: "Avatar", description: "Circle and rounded image or fallback primitives for people, agents, and accounts, with status, group, and compact user-detail composition.", isNew: true, gridSize: "small", order: 190, registryItem: { name: "avatar", type: "registry:ui" } }),
  entry({ slug: "badge", section: "data-display", icon: "doc-badge", name: "Badge", description: "Compact label with categorical colors, custom recipes, semantic statuses, and soft, strong, or dot variants.", gridSize: "small", order: 200 }),
  entry({ slug: "badge-overflow", section: "data-display", icon: "doc-badge-overflow", name: "BadgeOverflow", description: "Responsive badge list that collapses hidden items into an overflow count.", isNew: true, gridSize: "medium", order: 300 }),
  entry({ slug: "breadcrumb", section: "navigation", icon: "doc-breadcrumb", name: "Breadcrumb", description: "Composable path navigation with separators, current-page state, and collapsed levels.", isNew: true, gridSize: "medium", order: 400 }),
  entry({ slug: "button", section: "action", icon: "doc-button", name: "Button", description: "Versatile button with variants, sizes, loading state, and icon support.", gridSize: "small", order: 500 }),
  ...
  entry({ slug: "combobox", section: "input", icon: "doc-select", name: "Combobox", description: "Filterable single- or multi-select with typed object values, groups, chips, and custom triggers.", isNew: true, gridSize: "medium", order: 950 }),
  entry({ slug: "data-grid", section: "data-display", icon: "doc-data-grid", name: "DataGrid", description: "Virtualized spreadsheet grid with inline editing, range selection, search, copy and paste, and pinned columns.", isNew: true, gridSize: "large", order: 1000 }),
  entry({ slug: "code-block", section: "data-display", icon: "doc-data-grid", name: "CodeBlock", description: "Highlighted code, diffs, patches, conflicts, streaming, SSR, Workers, and editing.", isNew: true, gridSize: "large", order: 1050, registryItem: { name: "code-block", type: "registry:ui" } }),
  entry({ slug: "data-table", section: "data-display", icon: "doc-data-table", name: "DataTable", description: "TanStack data table with sorting, filters, pagination, selection, visibility, and pinning.", isNew: true, gridSize: "large", order: 1100 }),
  entry({ slug: "filter-builder", section: "data-display", icon: "doc-data-table", name: "FilterBuilder", description: "Composable typed filters for complex data views, with text, number, option, boolean, date, async, and custom editors.", isNew: true, gridSize: "large", order: 1125 }),
  ...
  entry({ slug: "field", section: "input", icon: "doc-input", name: "Field", description: "Accessible form composition for labels, descriptions, validation messages, groups, and fieldsets.", isNew: true, gridSize: "medium", order: 1350 }),
  entry({ slug: "input", section: "input", icon: "doc-input", name: "Input", description: "Text input with three variants, five sizes, and accessible validation states.", isNew: true, gridSize: "small", order: 1400 }),
  entry({ slug: "input-copy", section: "action", icon: "doc-input-copy", name: "InputCopy", description: "Read-only input with copy-to-clipboard button and animated feedback.", gridSize: "small", order: 1500 }),
  entry({ slug: "input-group", section: "input", icon: "doc-input-group", name: "InputGroup", description: "Composable input with addons, compact actions, textarea support, and validation.", isUpdated: true, gridSize: "small", order: 1600 }),
  entry({ slug: "info-item", section: "data-display", icon: "doc-info-item", name: "InfoItem", description: "Composable information row with leading media, primary and supporting text, and a flexible trailing value or detail.", isNew: true, gridSize: "medium", order: 1700 }),
  entry({ slug: "kbd", section: "action", icon: "doc-kbd", name: "Kbd", description: "Compact keycaps and shortcut groups for keyboard commands and interaction hints.", isNew: true, gridSize: "small", order: 1800 }),
  entry({ slug: "popover", section: "overlay", icon: "doc-popover", name: "Popover", description: "Collision-aware floating content with a liquid anchor-to-panel transition.", isNew: true, gridSize: "small", order: 1900 }),
  entry({ slug: "radio-group", section: "input", icon: "doc-radio-group", name: "RadioGroup", description: "Composable radio controls with form support and enhanced proximity-hover rows.", isUpdated: true, gridSize: "small", order: 2000 }),
  entry({ slug: "resizable", section: "layout", icon: "doc-separator", name: "Resizable", description: "Accessible split-pane layouts with pointer and keyboard resizing, semantic constraints, and optional visual grips.", isNew: true, gridSize: "medium", order: 2025 }),
  entry({ slug: "separator", section: "layout", icon: "doc-separator", name: "Separator", description: "Accessible horizontal and vertical rules with a semantic border color and layout-safe gutter.", isNew: true, gridSize: "small", order: 2050 }),
  entry({ slug: "skeleton", section: "feedback", icon: "doc-card", name: "Skeleton", description: "Token-native loading placeholder that composes into avatar, card, text, form, and table layouts.", isNew: true, gridSize: "small", order: 2075 }),
  entry({ slug: "select", section: "input", icon: "doc-select", name: "Select", description: "Animated select menu with bordered/borderless variants and optional icons.", gridSize: "medium", order: 2100 }),
  entry({ slug: "sortable-collection", section: "action", icon: "doc-data-table", name: "SortableCollection", description: "Controlled reorderable list with optional inline editing, removal, and catalog-based adding.", isNew: true, gridSize: "large", order: 2175 }),
  entry({ slug: "slider", section: "input", icon: "doc-slider", name: "Slider", description: "Range slider with step snapping, range mode, and animated thumb.", gridSize: "medium", order: 2200 }),
  ...
  entry({ slug: "textarea", section: "input", icon: "doc-input-group", name: "Textarea", description: "Multi-line text input with semantic variants, two content sizes, resizing, and field validation support.", isNew: true, gridSize: "small", order: 2650 }),
  entry({ slug: "toast", section: "feedback", icon: "doc-toast", name: "Toast", description: "Animated notification stack with statuses, automatic dismissal, actions, and drag gestures.", isNew: true, gridSize: "medium", order: 2700 }),
  entry({ slug: "tooltip", section: "overlay", icon: "doc-tooltip", name: "Tooltip", description: "Floating tooltip with spring-based animations and configurable placement.", gridSize: "small", order: 2800 }),
  ...
  blockEntry({ slug: "login-01", section: "application", icon: "doc-app-shell", name: "Login", description: "A card-based authentication flow with credential, Apple, and Google sign-in paths.", registryItem: { name: "login-01", type: "registry:block" }, isNew: true, order: 10 }),
  blockEntry({ slug: "signup-01", section: "application", icon: "doc-app-shell", name: "Signup", description: "A surface-neutral account creation flow with email, Apple, and Google signup paths.", registryItem: { name: "signup-01", type: "registry:block" }, isNew: true, order: 11 }),
  blockEntry({ slug: "availability-monitor-01", section: "application", icon: "doc-showcase", name: "Availability Monitor 1", description: "A routing-aware service availability block with summary metrics, a 72-hour status strip, and a 24-hour comparison chart.", registryItem: { name: "availability-monitor-01", type: "registry:block" }, isNew: true, order: 19 }),
  blockEntry({ slug: "ai-gateway-overview-01", section: "application", icon: "doc-sidebar", name: "AI Gateway Overview 1", description: "A complete AI gateway analytics workspace with responsive navigation, traffic, spend, tokens, latency, reliability, providers, and operations.", registryItem: { name: "ai-gateway-overview-01", type: "registry:block" }, isNew: true, order: 20 }),
  blockEntry({ slug: "ai-gateway-session-list-01", section: "application", icon: "doc-data-table", name: "AI Gateway Session List 1", description: "A controlled AI gateway session workspace with shared navigation, entity filters, error-only filtering, compact usage values, and responsive pagination.", registryItem: { name: "ai-gateway-session-list-01", type: "registry:block" }, isNew: true, order: 20.25 }),
  blockEntry({ slug: "agent-message-trace-01", section: "application", icon: "doc-showcase", name: "Agent Message Trace 1", description: "A responsive, resizable agent trace workspace with a virtualized timeline and span inspector.", registryItem: { name: "agent-message-trace-01", type: "registry:block" }, isNew: true, order: 20.5 }),
  ...
  blockEntry({ slug: "agent-session-detail-01", section: "application", icon: "doc-sidebar", name: "Agent Session Detail 1", description: "A session detail workspace with agent navigation, session switching, and an embedded execution trace.", registryItem: { name: "agent-session-detail-01", type: "registry:block" }, isNew: true, order: 21 }),
  ...
  blockEntry({ slug: "filter-rule-builder-01", section: "application", icon: "doc-data-table", name: "Filter Rule Builder", description: "A controlled filter workspace with presets, readable rule summaries, and validated draft editing.", registryItem: { name: "filter-rule-builder-01", type: "registry:block" }, isNew: true, order: 25.5 }),
  blockEntry({ slug: "rule-flow-editor-01", section: "application", icon: "doc-motion", name: "Rule Flow Editor", description: "A controlled visual rule editor with draggable trigger, condition, and action nodes.", registryItem: { name: "rule-flow-editor-01", type: "registry:block" }, isNew: true, order: 26 }),
  ...
  blockEntry({ slug: "inspection-report-list-01", section: "application", icon: "doc-data-table", name: "Inspection Report List 1", description: "An operations report workspace with shared navigation, filtering, freshness states, and row actions.", registryItem: { name: "inspection-report-list-01", type: "registry:block" }, isNew: true, order: 32 }),
  blockEntry({ slug: "monitoring-alert-list-01", section: "application", icon: "doc-data-table", name: "Monitoring Alert List 1", description: "A monitoring alert workspace with shared operations navigation, severity filters, and AI analysis actions.", registryItem: { name: "monitoring-alert-list-01", type: "registry:block" }, isNew: true, order: 33 }),
  blockEntry({ slug: "service-management-01", section: "application", icon: "doc-sidebar", name: "Service Management 1", description: "A shared service workspace for progress, vendor authorizations, and cluster operation history.", registryItem: { name: "service-management-01", type: "registry:block" }, isNew: true, order: 34 }),
  blockEntry({ slug: "traffic-rules-01", section: "application", icon: "doc-data-table", name: "流量规则", description: "A responsive gateway workspace for managing traffic rules, limits, validation, and execution workflows.", registryItem: { name: "traffic-rules-01", type: "registry:block" }, isNew: true, order: 34.5 }),
  blockEntry({ slug: "user-account-01", section: "application", icon: "doc-sidebar", name: "用户账号", description: "Controlled appearance, language, settings, notifications and sign-out entry points.", registryItem: { name: "user-account-01", type: "registry:block" }, isNew: true, order: 34 }),
  ...
  blockEntry({ slug: "resource-detail-page-01", section: "application", icon: "doc-sidebar", name: "Resource Detail Page", description: "A full-width generic resource detail page with shared navigation, editable metadata, protection settings, and caller-owned tab content.", registryItem: { name: "resource-detail-page-01", type: "registry:block" }, isNew: true, order: 48 }),
  ...
  blockEntry({ slug: "model-detail-02", section: "application", icon: "doc-card", name: "Model Analytics Detail", description: "A complete model analytics page with providers, pricing, performance, uptime, benchmarks, apps, activity, and FAQ.", registryItem: { name: "model-detail-02", type: "registry:block" }, isNew: true, order: 49 }),
  blockEntry({ slug: "resource-list-page-01", section: "application", icon: "doc-sidebar", name: "MCP Resource List Page", description: "A Sidebar workspace for managing MCP applications and categories with design-system-native tabs, filters, and tables.", registryItem: { name: "resource-list-page-01", type: "registry:block" }, isNew: true, order: 69 }),
  ...
  blockEntry({ slug: "member-department-01", section: "application", icon: "doc-data-table", name: "成员与部门", description: "A member directory and expandable department workspace with search, account-status filtering, and responsive organization details.", registryItem: { name: "member-department-01", type: "registry:block" }, isNew: true, order: 71 }),
  blockEntry({ slug: "infinite-log-table-01", section: "application", icon: "doc-data-table", name: "Infinite Log Table", description: "A schema-driven virtualized log explorer with dynamic fields and filters, cursor pagination, and Live tailing.", registryItem: { name: "infinite-log-table-01", type: "registry:block" }, isNew: true, order: 72 }),
  blockEntry({ slug: "file-manager-01", section: "application", icon: "doc-data-grid", name: "File Manager 1", description: "A token-native file-management workspace with icon, list, and Finder-style column views.", registryItem: { name: "file-manager-01", type: "registry:block" }, isNew: true, order: 72 }),
