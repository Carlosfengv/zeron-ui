...
export const docEntries = [
  ...
  blockEntry({ slug: "resource-catalog-01", section: "application", icon: "doc-card", name: "Resource Catalog", description: "A responsive model-service and MCP marketplace with search, sorting, page-local filters, and resource cards.", registryItem: { name: "resource-catalog-01", type: "registry:block" }, isNew: true, order: 45 }),
