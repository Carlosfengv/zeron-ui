...
export const docEntries = [
  ...
  entry({ slug: "resource-list-layout", section: "layout", icon: "doc-page-layout", name: "ResourceListLayout", description: "Full-height resource-list page preset with one title, caller-owned controls, scrolling results, and fixed pagination.", isNew: true, order: 225, registryItem: { name: "resource-list-layout", type: "registry:ui" } }),
