...
export const docEntries = [
  ...
  entry({ slug: "badge", section: "components", icon: "doc-badge", name: "Badge", description: "Compact label with categorical colors, semantic statuses, solid and dot variants, and three sizes.", gridSize: "small", order: 200 }),
  ...
  entry({ slug: "input", section: "components", icon: "doc-input", name: "Input", description: "Text input with three variants, four sizes, and accessible validation states.", isNew: true, gridSize: "small", order: 1400 }),
  ...
  entry({ slug: "tooltip", section: "components", icon: "doc-tooltip", name: "Tooltip", description: "Floating tooltip with spring-based animations and configurable placement.", gridSize: "small", order: 2700 }),
