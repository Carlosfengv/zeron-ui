...
export const docEntries = [
  ...
  blockEntry({ slug: "member-department-01", section: "application", icon: "doc-data-table", name: "成员与部门", description: "A department-scoped member directory with search, account-status filtering, and responsive organization navigation.", registryItem: { name: "member-department-01", type: "registry:block" }, isNew: true, order: 71 }),
