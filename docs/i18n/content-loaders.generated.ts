...
const pageLoaders: Record<AppLocale, Record<string, Loader>> = {
  en: {
    ...
    "components/resource-list-layout": () => import("@docs/content/en/components/resource-list-layout.json"),
  ...
  "zh-CN": {
    ...
    "components/resource-list-layout": () => import("@docs/content/zh-CN/components/resource-list-layout.json"),
