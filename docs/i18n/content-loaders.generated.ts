...
const pageLoaders: Record<AppLocale, Record<string, Loader>> = {
  en: {
    ...
    "blocks/ai-gateway-overview-01": () => import("@docs/content/en/blocks/ai-gateway-overview-01.json"),
    "blocks/ai-gateway-session-list-01": () => import("@docs/content/en/blocks/ai-gateway-session-list-01.json"),
    "blocks/agent-message-trace-01": () => import("@docs/content/en/blocks/agent-message-trace-01.json"),
    ...
    "blocks/monitoring-alert-list-01": () => import("@docs/content/en/blocks/monitoring-alert-list-01.json"),
    "blocks/service-management-01": () => import("@docs/content/en/blocks/service-management-01.json"),
    "blocks/traffic-rules-01": () => import("@docs/content/en/blocks/traffic-rules-01.json"),
    "blocks/mcp-detail-01": () => import("@docs/content/en/blocks/mcp-detail-01.json"),
    "blocks/resource-detail-page-01": () => import("@docs/content/en/blocks/resource-detail-page-01.json"),
    ...
    "components/time-range-histogram": () => import("@docs/content/en/components/time-range-histogram.json"),
    "components/temporal-picker": () => import("@docs/content/en/components/temporal-picker.json"),
    "components/thinking-indicator": () => import("@docs/content/en/components/thinking-indicator.json"),
    "components/tree": () => import("@docs/content/en/components/tree.json"),
    ...
    "components/avatar": () => import("@docs/content/en/components/avatar.json"),
    ...
    "components/filter-builder": () => import("@docs/content/en/components/filter-builder.json"),
    "components/filter-query-input": () => import("@docs/content/en/components/filter-query-input.json"),
    ...
    "components/status-overview": () => import("@docs/content/en/components/status-overview.json"),
    ...
    "components/combobox": () => import("@docs/content/en/components/combobox.json"),
    ...
    "components/empty": () => import("@docs/content/en/components/empty.json"),
    ...
    "components/skeleton": () => import("@docs/content/en/components/skeleton.json"),
    "components/slider": () => import("@docs/content/en/components/slider.json"),
    "components/sortable-collection": () => import("@docs/content/en/components/sortable-collection.json"),
    ...
    "blocks/credit-usage-01": () => import("@docs/content/en/blocks/credit-usage-01.json"),
    ...
    "blocks/filter-rule-builder-01": () => import("@docs/content/en/blocks/filter-rule-builder-01.json"),
    "blocks/resource-catalog-01": () => import("@docs/content/en/blocks/resource-catalog-01.json"),
    "blocks/resource-list-page-01": () => import("@docs/content/en/blocks/resource-list-page-01.json"),
    "blocks/resource-list-table-01": () => import("@docs/content/en/blocks/resource-list-table-01.json"),
    "blocks/member-department-01": () => import("@docs/content/en/blocks/member-department-01.json"),
    "blocks/infinite-log-table-01": () => import("@docs/content/en/blocks/infinite-log-table-01.json"),
    "blocks/file-manager-01": () => import("@docs/content/en/blocks/file-manager-01.json"),
    ...
    "blocks/resource-settings-01": () => import("@docs/content/en/blocks/resource-settings-01.json"),
    ...
    "blocks/zlrlist": () => import("@docs/content/en/blocks/zlrlist.json"),
  ...
  "zh-CN": {
    ...
    "blocks/ai-gateway-overview-01": () => import("@docs/content/zh-CN/blocks/ai-gateway-overview-01.json"),
    "blocks/ai-gateway-session-list-01": () => import("@docs/content/zh-CN/blocks/ai-gateway-session-list-01.json"),
    "blocks/agent-message-trace-01": () => import("@docs/content/zh-CN/blocks/agent-message-trace-01.json"),
    ...
    "blocks/monitoring-alert-list-01": () => import("@docs/content/zh-CN/blocks/monitoring-alert-list-01.json"),
    "blocks/service-management-01": () => import("@docs/content/zh-CN/blocks/service-management-01.json"),
    "blocks/traffic-rules-01": () => import("@docs/content/zh-CN/blocks/traffic-rules-01.json"),
    "blocks/mcp-detail-01": () => import("@docs/content/zh-CN/blocks/mcp-detail-01.json"),
    "blocks/resource-detail-page-01": () => import("@docs/content/zh-CN/blocks/resource-detail-page-01.json"),
    ...
    "components/time-range-histogram": () => import("@docs/content/zh-CN/components/time-range-histogram.json"),
    "components/temporal-picker": () => import("@docs/content/zh-CN/components/temporal-picker.json"),
    "components/thinking-indicator": () => import("@docs/content/zh-CN/components/thinking-indicator.json"),
    "components/tree": () => import("@docs/content/zh-CN/components/tree.json"),
    ...
    "components/avatar": () => import("@docs/content/zh-CN/components/avatar.json"),
    ...
    "components/filter-builder": () => import("@docs/content/zh-CN/components/filter-builder.json"),
    "components/filter-query-input": () => import("@docs/content/zh-CN/components/filter-query-input.json"),
    ...
    "components/status-overview": () => import("@docs/content/zh-CN/components/status-overview.json"),
    ...
    "components/combobox": () => import("@docs/content/zh-CN/components/combobox.json"),
    ...
    "components/empty": () => import("@docs/content/zh-CN/components/empty.json"),
    ...
    "components/skeleton": () => import("@docs/content/zh-CN/components/skeleton.json"),
    "components/slider": () => import("@docs/content/zh-CN/components/slider.json"),
    "components/sortable-collection": () => import("@docs/content/zh-CN/components/sortable-collection.json"),
    ...
    "blocks/credit-usage-01": () => import("@docs/content/zh-CN/blocks/credit-usage-01.json"),
    ...
    "blocks/filter-rule-builder-01": () => import("@docs/content/zh-CN/blocks/filter-rule-builder-01.json"),
    "blocks/resource-catalog-01": () => import("@docs/content/zh-CN/blocks/resource-catalog-01.json"),
    "blocks/resource-list-page-01": () => import("@docs/content/zh-CN/blocks/resource-list-page-01.json"),
    "blocks/resource-list-table-01": () => import("@docs/content/zh-CN/blocks/resource-list-table-01.json"),
    "blocks/member-department-01": () => import("@docs/content/zh-CN/blocks/member-department-01.json"),
    "blocks/infinite-log-table-01": () => import("@docs/content/zh-CN/blocks/infinite-log-table-01.json"),
    "blocks/file-manager-01": () => import("@docs/content/zh-CN/blocks/file-manager-01.json"),
    ...
    "blocks/resource-settings-01": () => import("@docs/content/zh-CN/blocks/resource-settings-01.json"),
    ...
    "blocks/zlrlist": () => import("@docs/content/zh-CN/blocks/zlrlist.json"),
