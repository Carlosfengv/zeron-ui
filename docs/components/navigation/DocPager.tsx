  ...
  return (
    <div className="flex items-center gap-1 shrink-0">
      {prev ? (
        ...
        <Button iconOnly variant="ghost" size="md" disabled aria-label={t("nonePrevious")}>
          <ArrowRight className="rotate-180" />
        </Button>
      )}
      {next ? (
        ...
        <Button iconOnly variant="ghost" size="md" disabled aria-label={t("noneNext")}><ArrowRight /></Button>
      )}
    </div>
  );
}
