...
export function PersonalSettingsBlockDocClient({ code }: { code: string }) {
  ...
  return <BlockDetailPage code={code} description={t("description")} registryName="personal-settings-01" slug="personal-settings-01" title={t("title")} preview={<PersonalSettings data={personalSettingsDemoData} />}>
