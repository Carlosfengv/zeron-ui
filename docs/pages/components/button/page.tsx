...
function PlayText({
  ...
  return (
    <input
      ...
      className="h-7 w-[124px] rounded-lg bg-transparent px-2 text-right text-label text-fg-default transition-colors duration-fast hover:bg-hover focus:bg-hover outline-none focus-visible:ring-1 focus-visible:ring-focus-ring"
    />
  );
}
