...
function ReplayableExample({
  ...
  const t = useTranslations("askUserQuestions");
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        title: "Tabs",
        description:
          "Segment tabs that morph between selections. Reach for these when section headers would be too loud.",
      },
      {
        id: "nav",
        title: "NavMenu",
...
const chipLeftCode = `const questions = [
  ...
  {
    id: "recommend",
    title: "Would you recommend Zeron Design?",
    chipPosition: "left",
    skippable: false,
    options: [
      { id: "yes", title: "Yes", description: "Already have" },
...
export default function AskUserQuestionsDoc() {
  ...
  return (
    ...
    >
      ...
      <DocSection title={t("multiSelect")}>
        <ReplayableExample
      ...
      <DocSection title={t("freeTextValidation")}>
        <ReplayableExample
          code={validateCode}
          align="bottom"
          minHeightClass="min-h-[560px]"
      ...
      <DocSection title={`${t("apiReference")} — AskUserQuestions`}>
        <PropsTable props={localize(componentProps, "c")} />
      </DocSection>

      <DocSection title={`${t("apiReference")} — AskUserQuestion`}>
        <PropsTable props={localize(questionProps, "q")} />
      </DocSection>

      <DocSection title={`${t("apiReference")} — AskUserOption`}>
        <PropsTable props={localize(optionProps, "o")} />
      </DocSection>

      <DocSection title={`${t("apiReference")} — AskUserAnswer`}>
        <PropsTable props={localize(answerProps, "a")} />
      </DocSection>
    </DocPage>
  );
}
