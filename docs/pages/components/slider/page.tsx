...
export default function SliderDoc() {
  ...
  return (
    ...
    >
      ...
      <DocSection title={t("nonUniformSteps")}>
      ...
      <DocSection title={t("valueDisplay")}>
      ...
      <DocSection title={t("comfortable")}>
      ...
      <DocSection title={t("comfortableScrubber")}>
      ...
      <DocSection title={t("comfortableFormat")}>
      ...
      <DocSection title={t("comfortableDisabled")}>
