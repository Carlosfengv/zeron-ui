...
<ThinkingSteps open={open} onOpenChange={setOpen}>
  ...
  <ThinkingStepsContent>
    <ThinkingStep icon="search"
      label="Searching for Zeron Design"
...
<ThinkingSteps open={open} onOpenChange={setOpen}>
  ...
  <ThinkingStepsContent>
    ...
    <ThinkingStep icon="image" label="Found profile photo"
      description="Zeron Design profile from x.com"
      status={getStatus(1)} isLast={visibleSteps <= 2}>
...
function AnimatedPreview({
  ...
  const t = useTranslations("thinkingSteps");
  ...
  return (
    ...
    >
      ...
      <DocSection title={t("apiReference")}>
        <h3 className="text-body font-semibold text-fg-default mb-2 mt-4">ThinkingSteps</h3>
        <PropsTable props={localize(rootProps, "r")} />

        <h3 className="text-body font-semibold text-fg-default mb-2 mt-6">ThinkingStepsHeader</h3>
        <PropsTable props={localize(headerProps, "h")} />

        <h3 className="text-body font-semibold text-fg-default mb-2 mt-6">ThinkingStep</h3>
        <PropsTable props={localize(stepProps, "s")} />

        <h3 className="text-body font-semibold text-fg-default mb-2 mt-6">ThinkingStepDetails</h3>
        <PropsTable props={localize(detailsProps, "e")} />

        <h3 className="text-body font-semibold text-fg-default mb-2 mt-6">ThinkingStepSource</h3>
        <PropsTable props={localize(sourceProps, "o")} />

        <h3 className="text-body font-semibold text-fg-default mb-2 mt-6">ThinkingStepImage</h3>
