...
export default function AppShellDoc() {
  return <DocPage title="AppShell" slug="app-shell" description="A composable application frame with no router or navigation-state coupling.">
    <DocSection title="Playground"><VariantPlayground padding="none" align="bottom" minHeightClass="min-h-[240px]" variants={[
      { value: "sidebar", label: "Sidebar", code: sidebarCode, preview: <div className="w-full p-5"><AppShell layout="sidebar" className="min-h-[200px] w-full overflow-hidden border border-border text-body"><AppShellSidebar className="border-r border-border bg-muted p-3">Sidebar</AppShellSidebar><AppShellHeader className="bg-surface-base p-3">Header</AppShellHeader><AppShellMain landmark={false} className="p-3">Main content</AppShellMain></AppShell></div> },
      { value: "stacked", label: "Stacked", code: stackedCode, preview: <div className="w-full p-5"><AppShell layout="stacked" className="min-h-[180px] w-full overflow-hidden border border-border text-body"><AppShellHeader className="bg-surface-base p-3">Header</AppShellHeader><AppShellMain landmark={false} className="p-3">Main content</AppShellMain></AppShell></div> },
    ]} /></DocSection>
    ...
    <DocSection title="Stacked layout"><ComponentPreview code={stackedCode} padding="none" minHeightClass="min-h-[180px]" align="bottom" fullScreenable><div className="w-full p-5 group-data-[fullscreen=true]/preview-content:h-full"><AppShell layout="stacked" className="min-h-[140px] w-full overflow-hidden text-body group-data-[fullscreen=true]/preview-content:h-full group-data-[fullscreen=true]/preview-content:min-h-0"><AppShellHeader className="bg-surface-base p-3">Header</AppShellHeader><AppShellMain landmark={false} className="p-3">Main content</AppShellMain></AppShell></div></ComponentPreview></DocSection>
