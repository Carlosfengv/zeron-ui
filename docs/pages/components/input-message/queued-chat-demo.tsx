              ...
              {isTouch && stackExpanded ? (
                ...
                <Tooltip content="Collapse" side="left">
                  <button
                    ...
                    className={`absolute bottom-0 left-0 flex items-center justify-center text-fg-muted outline-none hover:text-fg-default focus-visible:ring-1 focus-visible:ring-focus-ring rounded-lg`}
                ...
                >
                  <div
                    className="absolute bottom-0 left-0 flex items-center justify-end gap-1 pr-1 text-fg-muted"
                    style={{ height: CARD_H, width: 40 }}
                  >
                    ...
                    <AnimatePresence>
                      {hiddenCount > 0 && (
                        <motion.span
                          ...
                          className="pointer-events-none text-label font-semibold leading-none tabular-nums text-fg-muted"
                        >
                          {stackCount}
                        </motion.span>
                      )}
                      ...
                      >
                        <Tooltip content="Edit" side="top">
                          <button
                            ...
                            className={`flex h-8 w-8 shrink-0 cursor-pointer items-center justify-center rounded-lg text-fg-muted outline-none hover:bg-hover hover:text-fg-default focus-visible:ring-1 focus-visible:ring-focus-ring`}
                          >
