...
const AskUserQuestions = forwardRef<HTMLDivElement, AskUserQuestionsProps>(
  function AskUserQuestions(
    ...
    // fallback from the previous component layer). Arrows handle row-to-row movement; Tab
...
function Row({
  ...
  return (
    <div
      ...
      onKeyDown={onKeyDown}
      className={cn(
        "relative z-content flex cursor-pointer select-none outline-none",
    ...
    >
      {/* Selected background is drawn at the container level so contiguous
          ...
          selectedGroups / merged-bg block). Row keeps z-content to sit above it. */}
