 ...
 * the interactive component previews
 ...
 * (e.g. `variant` for Zeron Design, `shadcnVariant` for shadcn/ui).
 */

export const ACCORDION_ITEMS = [
  {
    value: "item-1",
    title: "What is Zeron Design?",
    content:
...
export const DROPDOWN_ITEMS: readonly {
  ...
  { value: "primitives", icon: "check", label: "Base UI primitives" },
