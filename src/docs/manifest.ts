...
export const docManifest = [
  ...
  page({ id: "info-item", pathname: "/docs/info-item", group: "components", name: "InfoItem", description: "Composable information row with leading media, primary and supporting text, and a flexible trailing value or detail.", isNew: true, gridSize: "medium" }),
